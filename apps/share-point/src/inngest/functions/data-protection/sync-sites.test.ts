...
import * as sitesConnector from '@/connectors/microsoft/share-point/sites';
import type { MicrosoftSite } from '@/connectors/microsoft/share-point/sites';
...
const setup = createInngestFunctionMock(syncSites, 'share-point/data_protection.sync.requested');
