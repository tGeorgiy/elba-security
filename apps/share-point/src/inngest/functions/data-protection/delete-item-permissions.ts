...
import { deleteItemPermission } from '@/connectors/microsoft/share-point/permissions';
import { MicrosoftError } from '@/common/error';
import { createElbaClient } from '@/connectors/elba/client';

export const deleteDataProtectionItemPermissions = inngest.createFunction(
  {
    id: 'share-point-delete-data-protection-object-permissions',
    concurrency: {
  ...
  { event: 'share-point/data_protection.delete_object_permissions.requested' },
  async ({ event, step }) => {
    const {
      id: itemId,
      organisationId,
